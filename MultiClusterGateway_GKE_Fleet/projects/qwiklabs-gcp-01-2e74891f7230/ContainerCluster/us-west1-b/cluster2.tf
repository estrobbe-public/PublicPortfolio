resource "google_container_cluster" "cluster2" {
  ...
  ip_allocation_policy {
    ...
    cluster_secondary_range_name = "gke-cluster2-pods-399a6ad9"
  ...
  subnetwork = "projects/qwiklabs-gcp-01-2e74891f7230/regions/us-west1/subnetworks/default"

  workload_identity_config {
    workload_pool = "qwiklabs-gcp-01-2e74891f7230.svc.id.goog"
  }
}
# terraform import google_container_cluster.cluster2 qwiklabs-gcp-01-2e74891f7230/us-west1-b/cluster2
