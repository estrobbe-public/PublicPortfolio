resource "google_compute_firewall" "gke_cluster2_399a6ad9_mcsd" {
  allow {
    protocol = "ah"
  }
  ...
  direction     = "INGRESS"
  name          = "gke-cluster2-399a6ad9-mcsd"
...
# terraform import google_compute_firewall.gke_cluster2_399a6ad9_mcsd projects/qwiklabs-gcp-01-2e74891f7230/global/firewalls/gke-cluster2-399a6ad9-mcsd
