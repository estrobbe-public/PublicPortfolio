resource "google_compute_disk" "gke_gke_cluster_02_st_default_pool_d5a67ba4_4h22" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-gke-cluster-02-st-default-pool-d5a67ba4-4h22"
...
# terraform import google_compute_disk.gke_gke_cluster_02_st_default_pool_d5a67ba4_4h22 projects/qwiklabs-gcp-02-4cd235752cc4/zones/europe-west1-b/disks/gke-gke-cluster-02-st-default-pool-d5a67ba4-4h22
