resource "google_container_cluster" "cluster1" {
  ...
  ip_allocation_policy {
    ...
    cluster_secondary_range_name = "gke-cluster1-pods-42c4ea4b"
...
# terraform import google_container_cluster.cluster1 qwiklabs-gcp-01-2e74891f7230/us-west1-b/cluster1
