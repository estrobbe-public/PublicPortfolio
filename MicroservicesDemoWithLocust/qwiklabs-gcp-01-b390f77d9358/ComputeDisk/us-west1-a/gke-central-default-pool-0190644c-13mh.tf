resource "google_compute_disk" "gke_central_default_pool_0190644c_13mh" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-central-default-pool-0190644c-13mh"
...
# terraform import google_compute_disk.gke_central_default_pool_0190644c_13mh projects/qwiklabs-gcp-01-b390f77d9358/zones/us-west1-a/disks/gke-central-default-pool-0190644c-13mh
