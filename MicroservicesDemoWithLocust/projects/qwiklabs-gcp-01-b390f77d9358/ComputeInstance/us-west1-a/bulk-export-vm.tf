resource "google_compute_instance" "bulk_export_vm" {
  boot_disk {
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/qwiklabs-gcp-01-b390f77d9358/zones/us-west1-a/disks/bulk-export-vm"
  }
...
# terraform import google_compute_instance.bulk_export_vm projects/qwiklabs-gcp-01-b390f77d9358/zones/us-west1-a/instances/bulk-export-vm
